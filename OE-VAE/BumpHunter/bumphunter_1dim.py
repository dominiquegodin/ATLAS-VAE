...
class BumpHunter1D:
    ...
    def bump_scan(self, data, bkg, is_hist: bool=False, do_pseudo: bool=True, verbose: bool=True):
        """
    ...
    @deprecated_arg("useSideBand", "use_sideband")
    def plot_bump(self, data, bkg, is_hist: bool=False, use_sideband=None,
                  filename=None, useSideBand=None, make_histo: bool=True):
        """
        Plot the data and bakground histograms with the bump found by BumpHunter highlighted.
