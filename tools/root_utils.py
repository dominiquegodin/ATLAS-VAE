...
def weights_factor(jet_tag, sample_type):
    if sample_type == 'UFO':
        ...
        DSIDsBSM           = ['302321', '302326', '302331', '310464', '310465',
                              ...
                              '449930', '503739']
        crossSecBSM      = [2.7610E+02, 4.6380E+01, 1.1160E+01, 2.5712E-03, 2.8366E-04,
        ...
        filtEffBSM       = [1.0000E+00, 1.0000E+00, 1.0000E+00, 4.6361E-01, 7.7126E-01,
        ...
        sumofweightsBSM  = [59663. , 69940. , 59977. , 40000. , 40000. ,
    ...
    if jet_tag in DSIDsBSM:
        tag_dict = dict(zip(DSIDsBSM, np.array(crossSecBSM)*np.array(filtEffBSM)/np.array(sumofweightsBSM)))    
